...
public class L_TitleLabelBundle_en_US extends ListResourceBundle {
    ...
    private final Object[][] contents = {
        ...
        // Q_PromptAddtScript
        {"AddScript", "\nCreating new script"},
        {"DefAddScr", "\nEnter a name of new script ending with .sql."},
        // Q_PromptImportScript
        {"ImpScript", "\nImport script from the directory in IBM i"},
        {"DefImpScr", "\nEnter script name to import."},
        // Q_ScriptEdit
        ...
        {"SearchScript", "Select scripts. Enter part of the name and press Enter key or \"Refresh\" button."},
        // Q_ScriptRunCall
