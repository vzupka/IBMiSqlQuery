...
public class L_TitleLabelBundle_cs_CZ extends ListResourceBundle {
    ...
    private final Object[][] contents = {
        ...
        // Q_PromptAddScript
        {"AddScript", "Vytvoření nového skriptu"},
        {"DefAddScr", "Zadejte jméno nového skriptu s koncovkou .sql."},
        // Q_PromptImportScript
        {"ImpScript", "\nImport skriptu z adresáře v IBM i"},
        {"DefImpScr", "\nZadejte jméno skriptu k importu."},
        // Q_ScriptEdit
        ...
        {"SearchScript", "Vybrat skripty. Napište část jména a stiskněte klávesu Enter nebo tlačítko \"Obnovit zobrazení\"."},
        // Q_ScriptRunCall
