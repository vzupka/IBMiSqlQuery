 ...
 *
 */
public class Q_PromptImportScript extends JDialog {
    ...
    String impScript, defImpScr;
    String exit, run_imp, isEmpty;
    ...
    public void showPrompt() {
        ...
        enterButton.addActionListener(a -> {
            if (textField.getText().isBlank()) {
                message.setText(isEmpty);  // Text field for Script Name must not be emmpty
                message.setForeground(DIM_RED); // red
                setVisible(true);
                return;  // 
            }              
            runImport();  // import the script file from IFS
        });
    ...
    protected String[] runImport() {
        String scriptFileName = textField.getText();
