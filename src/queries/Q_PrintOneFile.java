...
public class Q_PrintOneFile extends JDialog {
    ...
    private void createWindow() {
        ...
        text = buttons.getString("Text");

        exitButton = new JButton(exit);
        exitButton.setMinimumSize(new Dimension(95, 35));
        exitButton.setMaximumSize(new Dimension(95, 35));
        exitButton.setPreferredSize(new Dimension(95, 35));
        ...
        textButton.setMinimumSize(new Dimension(120, 35));
        textButton.setMaximumSize(new Dimension(120, 35));
        textButton.setPreferredSize(new Dimension(120, 35));
        textButton.setForeground(DIM_BLUE); // Dim blue
        textButton.setFont(new Font("Helvetica", Font.PLAIN, 14));
        ...
        // Set Text button activity
        // ------------------------
        // Get text file resulting from the script and process it by default text application 
        textButton.addActionListener(a -> {
            if (Desktop.isDesktopSupported()) {
                String uri = Paths
                        .get(System.getProperty("user.dir"), "printfiles", scriptName + ".txt").toString();
