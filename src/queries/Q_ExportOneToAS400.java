...
public class Q_ExportOneToAS400 {
    ...
    public static String transferOneToAS400(String scriptFileName) {
        ...
        if (!pingObj.ping()) {
            messageText = "! Server " + host + " timed out "
        ...
        try {
            inPath = Paths.get(System.getProperty("user.dir"), "scriptfiles", scriptFileName);
            client.setDataTransferType(FTP.BINARY);
            // FTP put
            client.put(inPath.toString(), ifsDirectory + scriptFileName);
